    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto space-y-12">
          <h1 className="text-4xl font-bold text-center text-primary mb-8">How NepPerks Works</h1>
          ...
          <section className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <p className="text-muted-foreground">
                Redeeming your hard-earned rewards has never been simpler! Once you've accumulated enough points, you can use them to enjoy exclusive discounts and offers at participating stores. Whether it's a percentage off your next purchase or a special deal on select items, your rewards are yours to choose. Just present your reward at the checkout, and see the savings apply instantly. It's a straightforward way to enjoy the fruits of your loyalty while supporting local businesses. Every redemption not only benefits you but also strengthens our community ties.
              </p>
              <img
                src="https://images.unsplash.com/photo-1544014384-f67fa5d18b56"
